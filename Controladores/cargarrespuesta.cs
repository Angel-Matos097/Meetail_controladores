...
public class cargarrespuesta : MonoBehaviour
{
    [Header("MATRICULA")]
    ...
    public void cargarrespuestas()
    {
        if(ya_se_cargo == false)
        {
            ...
            string query = "INSERT INTO respuestas_cdq (matricula, q1_i, q2_i, q3_i, q4_i, q5_i, q6_i, q7_i, q8_i, q9_i, q10_i, q11_i, q12_i, q13_i, q14_i, q15_i, q1_f, q2_f, q3_f, q4_f, q5_f, q6_f, q7_f, q8_f, q9_f, q10_f, q11_f, q12_f, q13_f, q14_f, q15_f) VALUES (@matricula, @q1_i, @q2_i, @q3_i, @q4_i, @q5_i, @q6_i, @q7_i, @q8_i, @q9_i, @q10_i, @q11_i, @q12_i, @q13_i, @q14_i, @q15_i, @q1_f, @q2_f, @q3_f, @q4_f, @q5_f, @q6_f, @q7_f, @q8_f, @q9_f, @q10_f, @q11_f, @q12_f, @q13_f, @q14_f, @q15_f)";

            MySqlCommand cmd = new MySqlCommand(query, connection);
            cmd.Parameters.AddWithValue("@matricula", text);
    ...
    {
          text = textInput.text;
          PlayerPrefs.SetString("MatriculaUsuario", text);
